...
func configShowCmd(f *appFlags, glValidator clihelp.OptionsValidator) clihelp.Command {
...
func configFileCmds(f *appFlags, glValidator clihelp.OptionsValidator) []clihelp.Command {
	return []clihelp.Command{
		{
			Name:             "edit",
...
func configCmd(f *appFlags, glValidator clihelp.OptionsValidator) clihelp.Command {
	return clihelp.Command{
		...
		Subcommands: configSubcommands(f, glValidator),
		Run: func(ctx *clihelp.Context) error {
			if f.global || f.local {
				cli.HandleConfigShow(f.global, f.local)
				return nil
